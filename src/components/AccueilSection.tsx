  ...
  return (
    <main className=" relative p-4">
      ...
      <div className="relative z-10 flex justify-center items-center p-6 sm:p-10">
        <div className="w-32 h-32 sm:w-[150px] sm:h-[150px] md:w-[200px] md:h-[200px] rounded-full overflow-hidden">
          <Image
            src="/IMG_4942.jpg"
            alt="Mathieu Arnaud"
            width={300}
      ...
      <div className="relative z-10 max-w-2xl mx-auto bg-[#f5f5f5]/90 backdrop-blur-sm rounded-lg shadow-[0_0_20px_rgba(0,0,0,0.1)] p-4 sm:p-6 md:p-8">
        <h2 className="text-xl sm:text-2xl md:text-4xl font-bold  text-center mb-4 sm:mb-6 md:mb-10 ">
        ...
        <div className="flex flex-row space-x-4 mt-6 sm:mt-10 md:mt-20 justify-center">
          <a
            href="#contact"
